"""CERES-Millet crop model — top-level coordinator.
...
Usage::
    ...
    cv = MilletCultivar(p1=350, p2o=12.5, p2r=100, p3=80, p4=40, p5=400,
                        g1=5.5, g2=8.0, phint=38.9, panth=450)
...
from dssat.crop.ceres_millet.phenology import MilletCultivar, MilletPhenology, PhenologyState
from dssat.crop.ceres_millet.growth import MilletGrowth, MilletGrowthState
from dssat.crop.ceres_millet.roots import grow_roots, root_water_uptake


class CeresMillet(CropModel):
    """CERES-Millet crop model.

    Implements the full CERES-Millet simulation cycle: phenology,
    ...
    def __init__(
        ...
        self._pheno = MilletPhenology(cultivar, pltpop, sdepth, yrsim)
        self._growth = MilletGrowth(cultivar, pltpop, rowspc, slpf)
    ...
    @property
    def growth(self) -> MilletGrowthState:
